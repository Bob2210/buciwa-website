...
const MEDIA_INFO: Record<string, MediaInfo> = {
  ...
  reviewImage1: {
    label: "真实评论截图 #01",
    location: "用户评论区（共创墙后）→ 第 1 张截图（横向短截图，建议 16:9 一句话评论气泡）",
    anchor: "/#reviews",
    group: "💬 真实用户评论（9 张截图）",
  },
  reviewImage2: {
    label: "真实评论截图 #02",
    location: "用户评论区（共创墙后）→ 第 2 张截图（横向短截图，建议 16:9 一句话评论气泡）",
    anchor: "/#reviews",
    group: "💬 真实用户评论（9 张截图）",
  },
  reviewImage3: {
    label: "真实评论截图 #03",
    location: "用户评论区（共创墙后）→ 第 3 张截图（横向短截图，建议 16:9 一句话评论气泡）",
    anchor: "/#reviews",
    group: "💬 真实用户评论（9 张截图）",
  },
  reviewImage4: {
    label: "真实评论截图 #04",
    location: "用户评论区（共创墙后）→ 第 4 张截图（横向短截图，建议 16:9 一句话评论气泡）",
    anchor: "/#reviews",
    group: "💬 真实用户评论（9 张截图）",
  },
  reviewImage5: {
    label: "真实评论截图 #05",
    location: "用户评论区（共创墙后）→ 第 5 张截图（横向短截图，建议 16:9 一句话评论气泡）",
    anchor: "/#reviews",
    group: "💬 真实用户评论（9 张截图）",
  },
  reviewImage6: {
    label: "真实评论截图 #06",
    location: "用户评论区（共创墙后）→ 第 6 张截图（横向短截图，建议 16:9 一句话评论气泡）",
    anchor: "/#reviews",
    group: "💬 真实用户评论（9 张截图）",
  },
  reviewImage7: {
    label: "真实评论截图 #07",
    location: "用户评论区（共创墙后）→ 第 7 张截图（横向短截图，建议 16:9 一句话评论气泡）",
    anchor: "/#reviews",
    group: "💬 真实用户评论（9 张截图）",
  },
  reviewImage8: {
    label: "真实评论截图 #08",
    location: "用户评论区（共创墙后）→ 第 8 张截图（横向短截图，建议 16:9 一句话评论气泡）",
    anchor: "/#reviews",
    group: "💬 真实用户评论（9 张截图）",
  },
  reviewImage9: {
    label: "真实评论截图 #09",
    location: "用户评论区（共创墙后）→ 第 9 张截图（横向短截图，建议 16:9 一句话评论气泡）",
    anchor: "/#reviews",
    group: "💬 真实用户评论（9 张截图）",
  },
  betaWechatQr: {
